  ...
  return (
    ...
    >
      <summary style={{ padding: '1rem 1.25rem', cursor: 'pointer', fontSize: '0.88rem', fontWeight: 600, color: '#374151', listStyle: 'none', display: 'flex', alignItems: 'center', userSelect: 'none' }}>
        <span aria-hidden="true">📋</span> Lihat analisis lengkap
        ...
        {hasStrengths && (
          <div>
            <h4 style={{ fontSize: '0.9rem', fontWeight: 700, margin: '0 0 0.6rem', color: '#065F46' }}>
              <span aria-hidden="true">✅</span> Ini yang sudah kuat (jangan diubah)
            </h4>
        ...
        {hasHr7 && (
          <div>
            <h4 style={{ fontWeight: 700, margin: '0 0 0.6rem', display: 'flex', alignItems: 'center', gap: 6, fontSize: '0.9rem' }}>
              <span aria-hidden="true">👁️</span> Yang HR lihat dalam 7 detik
              <Tooltip text="Riset menunjukkan HR hanya melihat CV 6-7 detik sebelum memutuskan lanjut atau tidak." />
            </h4>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div>
                <div style={{ fontSize: '0.68rem', fontWeight: 700, color: '#059669', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.4rem' }}><span aria-hidden="true">✅</span> Diperhatikan</div>
              ...
              <div>
                <div style={{ fontSize: '0.68rem', fontWeight: 700, color: '#DC2626', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.4rem' }}><span aria-hidden="true">⏭️</span> Dilewati</div>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '0.875rem', color: '#111827', display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
