  ...
  return (
    <div className="mt-4">
      <button
        ...
        className="w-full min-h-[44px] rounded-full bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-[0.98] text-white py-3 font-medium transition-all cursor-pointer text-sm"
