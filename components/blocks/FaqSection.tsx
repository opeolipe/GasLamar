...
export default function FaqSection() {
  return (
    <section className="py-8 md:py-12 max-w-3xl mx-auto">
      <h2 className="text-[clamp(1.8rem,3.5vw,2.8rem)] font-semibold mb-6 md:mb-10" style={SERIF}>FAQ</h2>
